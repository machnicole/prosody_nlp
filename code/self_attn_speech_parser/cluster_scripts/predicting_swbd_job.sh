...
dest_path2=${SCRATCH_HOME}/prosody_nlp/code/self_attn_speech_parser/models/swbd_no_speech_model_35_15_dev=90.92.pt
src_path2=${repo_home}/code/self_attn_speech_parser/models/swbd_no_speech_model_35_15_dev=90.92.pt
